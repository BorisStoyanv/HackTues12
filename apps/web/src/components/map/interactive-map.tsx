...
import { ShieldCheck, ArrowRight, MapPin, Zap, DollarSign, Users, Info, Clock, Briefcase } from "lucide-react";
...
import { ProposalView } from "../proposals/proposal-view";
  ...
  return (
    <div className={cn("relative w-full h-full bg-muted overflow-hidden", className)}>
        ...
        >
          ...
          <Layer
            ...
            paint={{
              ...
              'circle-stroke-color': resolvedTheme === 'dark' ? '#222' : '#eee',
            }}
          />
        </Source>
        ...
        {interactive && (
          <div className="absolute top-6 right-6 flex flex-col gap-2">
            <div className="bg-background/80 backdrop-blur-md border border-neutral-200 dark:border-neutral-800 p-1 rounded-xl shadow-2xl flex flex-col gap-1">
              <NavigationControl showCompass={false} position="top-right" style={{ position: 'relative' }} />
              <div className="h-px bg-neutral-200 dark:bg-neutral-800 mx-2" />
              <GeolocateControl positionOptions={{ enableHighAccuracy: true }} style={{ position: 'relative' }} />
            </div>
          </div>
        )}
            ...
            >
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center gap-1.5 text-[10px] font-bold text-muted-foreground uppercase tracking-tighter bg-neutral-100 dark:bg-neutral-900 px-2 py-0.5 rounded-md">
                   ...
                   {new Date(selectedProposal.created_at / 1000000).toLocaleDateString()}
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6 pt-4 border-t border-neutral-100 dark:border-neutral-900">
                 <div className="space-y-1">
                    <p className="text-[9px] font-black uppercase text-muted-foreground tracking-widest">Protocol Budget</p>
                 ...
                 <div className="space-y-1 text-right">
                    <p className="text-[9px] font-black uppercase text-muted-foreground tracking-widest">Node Consensus</p>
              ...
              <div className="flex gap-2">
                ...
                >
                  Full Audit <ArrowRight className="ml-2 h-3 w-3" />
                </Link>
                <Button 
                  variant="outline" 
                  size="icon" 
      ...
      <Sheet open={isDetailSheetOpen} onOpenChange={setIsDetailSheetOpen}>
        <SheetContent side="right" className="w-full sm:max-w-[800px] p-0 border-l-neutral-200 dark:border-l-neutral-800">
           <div className="h-full overflow-hidden flex flex-col">
              {selectedProposal && (
                 <ProposalView 
                   id={selectedProposal.id} 
                   mode={linkPrefix.includes('dashboard') ? 'authenticated' : 'public'} 
