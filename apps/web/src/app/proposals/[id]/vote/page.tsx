...
export default function VotePage() {
	...
	const isEligibleRegion =
		user?.detected_location?.city === proposal.location.city;
	...
	const totalWeightedPower =
		reputationScore * regionalMultiplier * expertiseMultiplier;
				...
				<Card className="max-w-md w-full border-neutral-200 dark:border-neutral-800 text-center">
					<CardHeader className="pt-12">
						...
						<CardDescription className="text-lg">
							Your cryptographic signature has been verified and
							added to the regional consensus pool.
						</CardDescription>
					</CardHeader>
						...
						<div className="p-4 rounded-lg bg-neutral-50 dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 space-y-2">
							...
							<div className="flex justify-between text-sm">
								...
								<span className="font-bold text-primary">
									{totalWeightedPower.toFixed(0)} $V_p$
								</span>
							</div>
						</div>
					</CardContent>
					<CardFooter className="flex flex-col gap-4 pb-12">
						...
						<p className="text-xs text-muted-foreground">
							...
							for participating in community governance.
						</p>
					</CardFooter>
				</Card>
			</div>
					...
					<div className="space-y-8">
						...
						<Card className="border-neutral-200 dark:border-neutral-800">
							<CardHeader>
								...
								<CardDescription>
									Choose your stance on this regional
									proposal.
								</CardDescription>
							</CardHeader>
							<CardContent>
								<RadioGroup
									onValueChange={setVoteValue}
								...
								>
									...
									<div
										className={cn(
											"relative flex items-center space-x-2 border rounded-xl p-4 cursor-pointer transition-all",
											voteValue === "abstain"
												? "border-neutral-400 bg-neutral-400/[0.02]"
												: "border-neutral-200 dark:border-neutral-800 hover:bg-neutral-50 dark:hover:bg-neutral-900",
										)}
									>
										<RadioGroupItem
						...
						<div className="p-4 rounded-xl bg-blue-50 dark:bg-blue-950/20 border border-blue-100 dark:border-blue-900 flex gap-3">
							...
							<p className="text-xs text-blue-700 dark:text-blue-300 leading-relaxed">
								Once signed, your vote cannot be changed. Your
								vote is cryptographic and verifiable on the
								transparency ledger.
							</p>
						</div>
					</div>
							...
							<CardContent className="space-y-6">
								...
								{!isEligibleRegion && (
									<div className="p-3 rounded-lg bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-900 text-[10px] text-amber-700 dark:text-amber-400">
										...
										Your current verified location is{" "}
										<strong>
											{user?.detected_location?.city ||
												"Unknown"}
										</strong>
										. Your vote on this{" "}
										{proposal.location.city} project will
								...
								{isEligibleRegion && (
									<div className="p-3 rounded-lg bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-900 text-[10px] text-green-700 dark:text-green-400">
										...
										gives you maximum voting power on this
